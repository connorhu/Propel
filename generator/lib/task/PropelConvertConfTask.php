...
class PropelConvertConfTask extends AbstractPropelDataModelTask
{
    ...
    public function main()
    {
        ...
        $output = "<?php\n";
        $output .= "// This file generated by Propel " . $phpconf['generator_version'] . " convert-conf target" . ($this->getGeneratorConfig()->getBuildProperty('addTimestamp') ? " on " . (new \DateTimeImmutable())->format('U') : '') . "\n";
