...
require_once __DIR__ . '/AbstractPropelDataModelTask.php';
require_once __DIR__ . '/../builder/om/ClassTools.php';
require_once __DIR__ . '/../builder/om/OMBuilder.php';
require_once __DIR__ . '/../model/diff/PropelDatabaseComparator.php';
require_once __DIR__ . '/../util/PropelMigrationManager.php';
